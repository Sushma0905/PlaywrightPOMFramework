...
- Name: login_functionality.spec.ts >> Verify that a user can log in with valid credentials
- Location: tests\login_functionality.spec.ts:7:5
    ...
    - list [ref=f1e6]:
      ...
      - listitem [ref=f1e16]:
        - link "Log out" [ref=f1e17] [cursor=pointer]:
          - /url: "#"
      - listitem [ref=f1e18]:
        - link "Welcome validauser" [ref=f1e19] [cursor=pointer]:
          - /url: "#"
      - listitem
    - generic [ref=f1e21]:
      - list [ref=f1e22]:
